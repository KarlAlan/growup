...
class TaskGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Task entity")
        ...
        .repeat(2) {
            ...
            .post("/api/tasks")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "declareValue":"0", "auditValue":"0", "status":null, "declareDate":"2020-01-01T00:00:00.000Z", "auditDate":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
